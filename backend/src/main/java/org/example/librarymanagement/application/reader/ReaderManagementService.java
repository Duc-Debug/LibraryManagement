...
public class ReaderManagementService implements ReaderManagementUseCase {
        ...
        public ReaderResult createReader(CreateReaderCommand command) {
                ...
                // 5. Khởi tạo Domain Object Readers (Mặc định trạng thái ACTIVE, hạn 1 năm, lưu
                // vết creatorId)
                ...
                Reader savedReader = readerRepositoryPort.save(newReader);
        ...
        public void deleteReader(Long readerId) {
                ...
                Reader reader = readerRepositoryPort
                                .findById(readerId)
        ...
        public PageResult<ReaderResult> getAllReaders(
                ...
                PageResult<Reader> domainPage = readerRepositoryPort.search(
