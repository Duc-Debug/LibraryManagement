...
public class CategoryManagementService
        ...
        public CategoryManagementService(
                ...
                this.categoryRepositoryPort = Objects.requireNonNull(
                                categoryRepositoryPort,
                                "Category repository port must not be null");
                this.categoryUsagePort = Objects.requireNonNull(
                                categoryUsagePort,
        ...
        public CategoryResult updateCategory(
                ...
                String requestedName = normalizeOptionalCommandName(command.name());
                String requestedDescription = normalizeOptionalCommandDescription(
                                command.description());
        ...
        private void ensureNameIsAvailableForAnotherCategory(
                ...
                boolean nameAlreadyUsed = categoryRepositoryPort.existsByNameAndIdNot(
                                name,
                                currentCategoryId);
