...
class CreateBookControllerTest {
    ...
    private CreateBookUseCase manageBookUseCase;
    ...
    void setUp() {
        ...
        manageBookUseCase = mock(CreateBookUseCase.class);
    ...
    void createBookSuccessfully() throws Exception {
        ...
        // Cập nhật: Dùng mock(Book.class) thay vì new Book() do đã áp dụng Rich Domain
